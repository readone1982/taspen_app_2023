...
<head>
    <meta charset="utf-8">
    <title>{{$layanan->number}}</title>
    @include('tenant.layanan.pdf_styles')
</head>
<body>
        ...
        <tr>
            ...
            <td style="padding: 0;margin: 0;width: 92%;text-align: center;">
                <ul class="px-0 list-unstyled">
                    <li style="font-weight: bold;font-size: 20px;font-weight: bold;padding-bottom: 4px;">FORMULIR LAYANAN</li>
                    <li style="font-size: 15px;font-weight: bold;padding-bottom: 4px;">{{$layanan->number}}</li>
                </ul>
            </td>
            <td>&nbsp;</td>
        </tr>
                ...
                <td style="padding: 0;margin: 0;padding-left: 10px;padding-right: 10px;">
                    <table style="width: 100%;padding: 0;margin: 0;">
                        <tr>
                            ...
                            <td style="padding: 0;margin: 0;text-align: left;vertical-align: top;font-size: 12px;padding: 5px;font-weight: bold;">
                                {{strtoupper($layanan->request_name)}}
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 0;margin: 0;width: 30%;text-align: left;vertical-align: top;font-size: 12px;padding: 5px;">
                            ...
                            <td style="padding: 0;margin: 0;text-align: left;vertical-align: top;font-size: 12px;padding: 5px;font-weight: bold;">
                                {{date('d/m/Y H:i', strtotime($layanan->request_date))}}
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 0;margin: 0;width: 30%;text-align: left;vertical-align: top;font-size: 12px;padding: 5px;">
                            ...
                            <td style="padding: 0;margin: 0;text-align: left;vertical-align: top;font-size: 12px;padding: 5px;font-weight: bold;">
                                {{strtoupper($layanan->request_phone)}}
                            </td>
                        </tr>
                    </table>
                </td>
                <td style="padding: 0;margin: 0;padding-left: 10px;padding-right: 10px;">
                    <table style="width: 100%;padding: 0;margin: 0;">
                        <tr>
                            ...
                            <td style="padding: 0;margin: 0;text-align: left;vertical-align: top;font-size: 12px;padding: 5px;font-weight: bold;">
                                {{strtoupper($layanan->received_name)}}
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 0;margin: 0;width: 30%;text-align: left;vertical-align: top;font-size: 12px;padding: 5px;">
                            ...
                            <td style="padding: 0;margin: 0;text-align: left;vertical-align: top;font-size: 12px;padding: 5px;font-weight: bold;">
                                {{date('d/m/Y H:i', strtotime($layanan->received_date))}}
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 0;margin: 0;width: 30%;text-align: left;vertical-align: top;font-size: 12px;padding: 5px;">
                            ...
                            <td style="padding: 0;margin: 0;text-align: left;vertical-align: top;font-size: 12px;padding: 5px;font-weight: bold;">
                                {{strtoupper($layanan->received_through)}}
                            </td>
                        </tr>
                    </table>
                </td>
