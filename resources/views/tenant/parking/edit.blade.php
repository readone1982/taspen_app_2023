                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea id="form_handling" name="form_handling" class="form-control" rows="2" placeholder="">{{$layanan->form_handling}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea id="response" name="response" class="form-control" rows="2">{{$layanan->response}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
