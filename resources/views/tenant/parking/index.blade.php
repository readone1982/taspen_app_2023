        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"><i class="la la-list-ul"></i> Tenant Relation - Parking Permission</h4>
                    <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            <li><a href="{{url('/tenant/parking/create')}}" class="btn btn-sm btn-info btn-min-width box-shadow-3">Add Data</a></li>
                            <li><a href="{{url('/report/flt')}}" class="btn btn-sm btn-primary btn-min-width box-shadow-3">Exports</a></li>
                                            ...
                                            <table class="table table-striped table-bordered zero-configuration table-responsive">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Catatan</th>
                                                        <th>Updated At / Done Time Tenant Relation</th>
                                                        <th>Actions</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                        ...
                                                        <td class="text-nowrap">
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <a href="{{url('/tenant/parking/detail/'.$item->id)}}" class="btn btn-sm btn-outline-primary" title="Detail">
                                                                        <i class="la la-file-text">Detail</i>
                                                                    </a>
                                                                    @if($item->status == 'Process')
                                                                    <a href="{{url('/tenant/parking/edit/'.$item->id)}}" class="btn btn-sm btn-outline-warning" title="Edit">
                                                                    ...
                                                                    @endif
                                                                    <a href="{{url('/tenant/parking/pdf/'.$item->id)}}" target="_blank" class="btn btn-sm btn-outline-primary" title="Print">
                                                                        <i class="la la-print">Print</i>
                                                                    </a>
                                                                    <a href="{{url('flt-email')}}" class="btn btn-sm btn-outline-primary" title="Print">
                                                                        <i class="la la-print">Send Email</i>
                                                                    </a>
                                                                    </a>
                                                                </ul>
                                                              </div>
