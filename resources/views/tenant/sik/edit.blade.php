            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="form-horizontal" novalidate method="POST" action="{{url('tenant/sik/update/'.$sik->id)}}">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    @foreach ($unit as $item)
                                                        <option value="{{$item->id}}" {{($sik->unit == $item->full_number ? 'selected' : '')}}>{{$item->full_number.($item->owner != null ? ' - '.$item->owner->name : '')}}</option>
                                                    @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" id="contractor_name" name="contractor_name" class="form-control w-100" placeholder="Nama Kontraktor" value="{{$sik->contractor_name}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" id="pic_name" name="pic_name" class="form-control w-100" placeholder="Penanggung Jawab" value="{{$sik->pic_name}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <h5>Telephone/HP</h5>
                                                <div class="controls">
                                                    <input type="text" id="phone" name="phone" class="form-control" placeholder="Telephone" value="{{$sik->phone}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="number" id="total_workers" name="total_workers" class="form-control" placeholder="Jumlah Pekerja" value="{{$sik->total_workers}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5>Ruang Lingkup Pekerjaan</h5>
                                                    <div class="controls">
                                                        <textarea class="form-control w-100" rows="4">{{$sik->scope_work}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="date" id="period_start" name="period_start" class="form-control w-100" value="{{$sik->period_start}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="date" id="period_end" name="period_end" class="form-control w-100" min="{{date('Y-m-d')}}" value="{{$sik->period_end}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <h5>Periode Mulai Pekerjaan</h5>
                                                <div class="controls">
                                                    <input type="date" id="sik1_start" name="sik1_start" class="form-control w-100" value="{{$sik->sik1_start}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <h5>Periode Selesai Pekerjaan</h5>
                                                <div class="controls">
                                                    <input type="date" id="sik1_end" name="sik1_end" class="form-control w-100" value="{{$sik->sik1_end}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <h5>Periode Mulai Pekerjaan</h5>
                                                <div class="controls">
                                                    <input type="date" id="sik2_start" name="sik2_start" class="form-control w-100" value="{{$sik->sik2_start}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <h5>Periode Selesai Pekerjaan</h5>
                                                <div class="controls">
                                                    <input type="date" id="sik2_end" name="sik2_end" class="form-control w-100" value="{{$sik->sik2_end}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <h5>Periode Mulai Pekerjaan</h5>
                                                <div class="controls">
                                                    <input type="date" id="sik3_start" name="sik3_start" class="form-control w-100" value="{{$sik->sik3_start}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <h5>Periode Selesai Pekerjaan</h5>
                                                <div class="controls">
                                                    <input type="date" id="sik3_end" name="sik3_end" class="form-control w-100" value="{{$sik->sik3_end}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
