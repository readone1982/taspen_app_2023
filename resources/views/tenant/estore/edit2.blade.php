        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-square-controls">Estore || Penerimaan Paket - Edit Data to Taked</h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="form-horizontal" novalidate method="POST" enctype="multipart/form-data" action="{{url('tenant/estore/update2/'.$estore->id)}}">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="sender_name" name="sender_name" class="form-control" required data-validation-required-message="This field is required" placeholder="Nama Pemohon" value="{{$estore->sender_name}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="ekspedisi" name="ekspedisi" class="form-control" required data-validation-required-message="This field is required" placeholder="Nama Pemohon" value="{{$estore->ekspedisi}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="receiver_name" name="receiver_name" class="form-control" placeholder="Nama Pasar" value="{{$estore->receiver_name}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="hp" name="hp" class="form-control" placeholder="Nomor Handphone" value="{{$estore->number}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                @endif
                                                <input type="file" accept="image/*" capture="camera" id="receiver_image1" name="receiver_image1" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" id="take_date" name="take_date" class="form-control" value="{{date('Y-m-d').'T'.date('H:i')}}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
