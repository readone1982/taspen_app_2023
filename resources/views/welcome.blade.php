                                ...
                                <div class="card-body">
                                    <div class="media d-flex">
                                        <div class="media-body text-left">
                                            ...
                                            <?php
                                            if ($bus4 > "5") {
                                                echo '<h6 style="font-weight: bold;color: rgb(255, 5, 5);">SOLO/YOGYAKARTA VIA UTARA '  . $bus4 . ' / 40 </h6>';
                                            } else {
                                                echo '<h6 style="font-weight: bold;color: rgb(0, 0, 0);">SOLO/YOGYAKARTA VIA UTARA '  . $bus4 . ' / 40 </h6>';
                                            }
                                            ?>
