    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                @php
                $bus1 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 1')->count();
                $bus2 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 2')->count();
                $bus3 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 3')->count();
                $bus4 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 4')->count();
                $bus5 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 5')->count();
                $bus6 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 6')->count();
                $bus7 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 7')->count();
                $bus8 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 8')->count();
                $bus9 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 9')->count();
                $bus10 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 10')->count();
                $bus11 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 11')->count();
                $bus12 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 12')->count();
                $bus13 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 13')->count();
                $bus14 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 14')->count();
                $bus15 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 15')->count();
                $bus16 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 16')->count();
                $bus17 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 17')->count();
                $bus18 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 18')->count();
                $bus19 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 19')->count();
                $bus20 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 20')->count();
                $bus21 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 21')->count();
                $bus22 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 22')->count();
                $bus23 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 23')->count();
                $bus24 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 24')->count();
                $bus25 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 25')->count();
                $bus26 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 26')->count();
                $bus27 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 27')->count();
                $bus28 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 28')->count();
                $bus29 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 29')->count();
                $bus30 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 30')->count();
                $bus31 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 31')->count();
                $bus32 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 32')->count();
                $bus33 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 33')->count();
                $bus34 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 34')->count();
                $bus35 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 35')->count();
                $bus36 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 36')->count();
                $bus37 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 37')->count();
                $bus38 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 38')->count();
                $bus39 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 39')->count();
                $bus40 = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS 40')->count();
                $busa = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS A')->count();
                $busb = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS B')->count();
                $busc = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS C')->count();
                $busd = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS D')->count();
                $buse = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS E')->count();
                $busf = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS F')->count();
                $busg = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS G')->count();
                $bush = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS H')->count();
                $busi = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS I')->count();
                $busj = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS J')->count();
                $busk = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS K')->count();
                $busl = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS L')->count();
                $busm = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS M')->count();
                $busn = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS N')->count();
                $buso = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS O')->count();
                $busp = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS P')->count();
                $busq = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS Q')->count();
                $busr = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS R')->count();
                $buss = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS S')->count();
                $bust = \App\TicketList::whereNull('deleted_at')->where('coding_bus', 'BUS T')->count();
                @endphp
                <div class="row">
...
{{--  --}}
                                            ...
                                            <?php
                                            if ($bus27 > "35") {
                                                echo '<h6 style="font-weight: bold;color: rgb(255, 5, 5);"> BUS 27 - SURABAYA VIA UTARA '  . $bus27 . ' / 40 </h6>';
                                            } else {
                                                echo '<h6 style="font-weight: bold;color: rgb(0, 0, 0);">BUS 27 - SURABAYA VIA UTARA '  . $bus27 . ' / 40 </h6>';
                                            }
                                            ?>
                                            <?php
                                            if ($bus28 > "35") {
                                                echo '<h6 style="font-weight: bold;color: rgb(255, 5, 5);"> BUS 28 - SURABAYA VIA UTARA '  . $bus28 . ' / 40 </h6>';
                                            } else {
                                                echo '<h6 style="font-weight: bold;color: rgb(0, 0, 0);">BUS 28 - SURABAYA VIA UTARA '  . $bus28 . ' / 40 </h6>';
                                            }
                                            ?>
                                            <?php
                                            if ($bus29 > "35") {
                                                echo '<h6 style="font-weight: bold;color: rgb(255, 5, 5);"> BUS 29 - SURABAYA VIA UTARA '  . $bus29 . ' / 40 </h6>';
                                            } else {
                                                echo '<h6 style="font-weight: bold;color: rgb(0, 0, 0);">BUS 29 - SURABAYA VIA UTARA '  . $bus29 . ' / 40 </h6>';
                                            }
                                            ?>
                                            <?php
                                            if ($bus30 > "35") {
                                                echo '<h6 style="font-weight: bold;color: rgb(255, 5, 5);"> BUS 30 - SURABAYA VIA UTARA '  . $bus30 . ' / 40 </h6>';
                                            } else {
                                                echo '<h6 style="font-weight: bold;color: rgb(0, 0, 0);">BUS 30 - SURABAYA VIA UTARA '  . $bus30 . ' / 40 </h6>';
                                            }
                                            ?>
